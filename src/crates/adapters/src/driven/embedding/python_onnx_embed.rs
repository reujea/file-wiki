...
impl file_pipeline_core::ports::outbound::OutboundManifest for PythonOnnxEmbeddingAdapter {
    fn id(&self) -> &str { "fp-outbound-embedding-python-onnx" }
    ...
    fn capabilities(&self) -> file_pipeline_core::ports::output::ResourceCapabilities {
        file_pipeline_core::ports::output::ResourceCapabilities::standard("python-onnx")
    }
}
