...
impl file_pipeline_core::ports::outbound::OutboundManifest for WebDavStorageAdapter {
    fn id(&self) -> &str { "fp-outbound-storage-webdav" }
    ...
    fn capabilities(&self) -> file_pipeline_core::ports::output::ResourceCapabilities {
        file_pipeline_core::ports::output::ResourceCapabilities::standard("webdav")
    }
}
